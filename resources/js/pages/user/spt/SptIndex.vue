...
// const printItem = (id) => {
//   // window.open(`/spts/${id}/cetak`, '_blank')
//   window.open(`http://localhost:8000/api/spts/${id}/cetak`, '_blank')
// }
...
const printItem = async (id) => {
  try {
    ...
    console.log("Cetak SPT berhasil", { spt_id: id }); // log
  } catch (error) {
